...
const generateAIReview = async () => {
  ...
  try{
    const promptMessage = `
      너는 영화 평론 유튜버야. 이제 영화 데이터를 기반으로 블로그 글처럼
...
<template>
        ...
        <div class="info-zone">
          ...
          <div class="meta-dashboard">
            ...
            <span class="badge runtime">
              🕒 {{ store.selectedMovie?.runtime }}분
            </span>

            <span class="badge release">
              🗓️ {{ store.selectedMovie?.release_date }} 개봉
            </span>
          </div>
  ...
  >
    ...
    <p class="loading-text">
      시네마틱 데이터 센터로부터 초고화질 상세 정보를 퍼 올라는 중입니다...
    </p>
  </div>
