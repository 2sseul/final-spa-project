...
.movie-card { border-radius: 12px; overflow: hidden; background: white; text-align: left; box-shadow: 0 4px 15px rgba(0,0,0.05); transition: transform 0.2s ease; display: flex; flex-direction: column; }
